    ...
    <section class="text-center p-5" style="background-image: url({{ asset('nimages/rect2.png') }})">
        ...
        <div class="row mt-4 align-items-center">
            <div class="col-12 col-md-6">
                <div style="height: 350px" class="p-3 bg-black shadow"></div>

            </div>
            <div class="col-6 text-left">
                <h6 class="text-left mb-4">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem explicabo facere fuga harum id labore provident quas repudiandae sit suscipit.
                </h6>
                <button data-target="#login-modal" data-toggle="modal" class="btn btn-dark btn-lg px-5 py-3 " style="border-radius: 0px !important;">SE CONNECTER</button>
                <button data-target="#register-modal" data-toggle="modal" class="btn btn-dark btn-lg px-5 py-3 " style="border-radius: 0px !important;">S'INSCRIRE</button>
            </div>
        </div>
    </section>
                                    ...
                                    <div class="login-modal-right">
                                        ...
                                        <form action="{{ route('auth.register') }}" method="post" class="tab-pane" id="register" role="tabpanel">
                                            ...
                                            <div class="pretty w-100 p-icon p-toggle p-plain">
                                                ...
                                                <div style="color: black; border: 1px solid black" class="state p-on  rounded w-100 p-3">
                                                    <span>Je suis une boutique</span>

                                                </div>
                                                <div style="color: black; border: 1px solid black; opacity: 0.3" class="state p-off  rounded w-100 p-3">
                                                    <span>Je suis une boutique</span>
                                                </div>
                                            </div>
                                                <fieldset class="form-group">
