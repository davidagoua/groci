                        ...
                        <div x-data="{q: ''}"  class="modal  fade" id="modal-categorie-{{ $categorie->id }}">
                            ...
                            <div class="modal-dialog  modal-lg" >
                                <div class="modal-content " style="width: 100%">
                                            ...
                                            <ul class="list-group">
                                                @foreach($categorie->enfants()->orderBy('order')->get() as $scat)
                                                    <li class="list-group-item">
                                                        <a
                                                            x-show="'{{$scat->name}}'.toLowerCase().indexOf(q.toLowerCase()) !== -1"
                                                            href="{{ route('front.shop.search') }}?cats[0]={{ $scat->id }}&parent={{$categorie->id}}"
                                                            class=" mt-3 category-card">
                                                            <div data-aos="flip-left" data-aos-easing="ease-in-back" class="p-3  bg-white text-center" >
                                                                <img class="img-fluid" style="border: 5px solid red; border-radius: 7px;height: 140px"
                                    ...
                                    @else()
                                        <div class="modal-body">
                                            <x-catalog-categorie :categorie-id="$categorie->id"/>
                                        </div>
                                    @endif
                                </div>
                            </div>
