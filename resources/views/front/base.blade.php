                                ...
                                <div class="login-modal-right">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="login" role="tabpanel">
                                            ...
                                            <fieldset class="form-group">
                                                <button type="submit" class="btn btn-lg btn-secondary btn-block">Se connecter</button>
                                            </fieldset>
                                        ...
                                        <div class="tab-pane" id="register" role="tabpanel">
                                            ...
                                            <fieldset class="form-group">
                                                <button type="submit" class="btn btn-lg btn-secondary btn-block">Créer mon compte</button>
                                            </fieldset>
                                            <div class="custom-control custom-checkbox">
                                    ...
                                    <div class="text-center login-footer-tab">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#login" role="tab"><i class="mdi mdi-lock"></i> CONNEXION</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#register" role="tab"><i class="mdi mdi-pencil"></i> INSCRIPTION</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="clearfix"></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                @guest()
                <a href="#" data-target="#bd-example-modal" data-toggle="modal" class="text-white ml-3 mr-3"><i class="mdi mdi-lock"></i>Se connecter</a>
                <a href="#" data-target="#bd-example-modal" data-toggle="modal" class="text-white"><i class="mdi mdi-account-circle"></i> S'inscrire</a>
                @endguest

                @auth()
                <a href="#" class="text-white ml-3 mr-3"><i class="mdi mdi-lock"></i>Se déconnecter</a>
                @endauth
            </div>
        </div>
    </div>
...
<nav class="navbar navbar-light navbar-expand-lg bg-dark bg-faded osahan-menu">
    <div class="container">
        <a class="navbar-brand" href="{{ route('front.home') }}"> <img src="../../../public/front/img/logo.png" alt="logo"> </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <h4 class="mb-5 mt-0"><a class="logo" href="index.html"><img src="../../../public/front/img/logo-footer.png" alt="Groci"></a></h4>
                ...
                <p class="mb-0"><a class="text-success" href="#"><i class="mdi mdi-email"></i> <span class="__cf_email__" data-cfemail="b3dad2dedcc0d2dbd2ddf3d4ded2dadf9dd0dcde">[email&#160;protected]</span></a></p>
...
<script src="/front/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="fb3ffff9a2f2592259cfd08d-|49" defer=""></script>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"7a8486894add2a2c","version":"2023.2.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}' crossorigin="anonymous"></script>
