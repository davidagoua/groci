                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="ml-3">
                                                            @foreach($scat->enfants as $sscat)
                                                                <div class="custom-control custom-checkbox">
                                                                    <input name="sous_sous_categorie_id" wire:model="selectedSousSousCategorie" value="{{ $sscat->id }}" data-select-id="{{$selectedSousSousCategorie}}" data-current-categorie="{{$sscats}}" @if($selectedSousSousCategorie == $sscat->id) checked @endif type="checkbox"
