                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="ml-3">
                                                            @foreach($scat->enfants as $sscat)
                                                                <div class="custom-control custom-checkbox">
                                                                    <input name="sous_sous_categorie_id" wire:model="sscats" value="{{ $sscat->id }}" data-select-id="{{$selectedSousSousCategorie}}" @if($selectedSousSousCategorie == $sscat->id) checked="true" @endif type="checkbox"
