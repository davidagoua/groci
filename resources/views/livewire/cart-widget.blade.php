    ...
    <div>
        <div class="cart-sidebar">
            ...
            <div class="cart-sidebar-footer">
                ...
                <a href="{{ route('front.shop.comparaison')}}" class="btn btn-secondary btn-lg btn-block text-left" type="button"><span class="float-left"><i class="mdi mdi-cart-outline"></i> Comparer </span><span class="float-right"><strong>{{ $total }} FCFA</strong> <span class="mdi mdi-chevron-right"></span></span></a>
