<div x-data="{
    ...
    <div class="d-flex row">
        <div class="col-md-4 border-b border-none border">
            ...
            <a class="d-block p-1 mt-2 rounded shadow bg-white text-center" :style="{'background-color': selectedId == {{$scat->id}} ? '#ff7675' : '', }" href="#" @click.prevent="getCategorieEnfants({{$scat->id}})">
        ...
        <div class="col-md-4">
            ...
            <div x-show="enfants.length > 0" >
                ...
                <template x-for="enfant in enfants" :key="enfant.id">
                    <a :href="'{{ route('front.shop.search') }}?cats[0]='+enfant.id +'&parent=enfant.parent_id'" class="d-block shadow bg-white rounded align-items-center p-1 d-flex align-items-center ">
