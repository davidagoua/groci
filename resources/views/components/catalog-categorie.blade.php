<div x-data="{
    ...
    <div class="d-flex row">
        <div class="col-md-4 border-b border-none border" style="max-height: 80vh; overflow-y: scroll">
            ...
            <a class="d-block p-1 mt-2 rounded shadow bg-white text-center" :class="{'border border-danger border-2': selectedId === {{$scat->id}}  }" href="#" @click.prevent="getCategorieEnfants({{$scat->id}})">
