        ...
        <div class="col-md-4">
            ...
            <div x-show="enfants.length > 0" x-transition>
                ...
                <template x-for="enfant in enfants" :key="enfant.id">
                    <a :href="'{{ route('front.shop.search') }}?cats[0]='+enfant.id +'&parent='+enfant.parent_id+'&sous_sous_categorie_id='+enfant.id+'&parent2='+{{$categorie->id}}" class="d-block mb-2 shadow bg-white rounded align-items-center p-1 d-flex align-items-center ">
