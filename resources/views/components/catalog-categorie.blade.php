<div x-data="{
    ...
    <div class="d-flex row">
        <div class="col-md-4 border-b border-none border" style="max-height: 80vh; overflow-y: scroll">
            ...
            <a class="d-block p-1 mt-2 rounded shadow bg-white text-center" :class="{'border border-danger': selectedId === {{$scat->id}}  }" href="#" @click.prevent="getCategorieEnfants({{$scat->id}})">
        ...
        <div class="col-md-4">
            ...
            <div x-show="enfants.length > 0" x-transition>
                ...
                <template x-for="enfant in enfants" :key="enfant.id">
                    <a :href="'{{ route('front.shop.search') }}?cats[0]='+enfant.id +'&parent=enfant.parent_id'" class="d-block mb-1 shadow bg-white rounded align-items-center p-1 d-flex align-items-center ">
